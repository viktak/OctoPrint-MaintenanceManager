...
class MaintenanceManagerPlugin(
    ...
    def initialize(self):
        ...
        self.trackingService = TrackingService(self)
    ...
    def update_maintenance_stats(
        ...
        if self.mqtt_helper:
            ...
            try:
                self.mqtt_helper["mqtt_publish"](topic, payload, allow_queueing=True)
                self._logger.info("Maintenance data published to MQTT.")
            except Exception as e:
                self._logger.error(f"Failed to publish to MQTT: {e}")
    ...
    def get_assets(self):
        ...
        # core UI here.
        return {
            "js": ["js/MaintenanceManager.js", "js/MaintenanceManager-APIClient.js"],
